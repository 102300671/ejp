    ...
    <div class="container">
        <div class="chat-box">
            <div class="chat-header">
                <h2>好友聊天 - <span id="current-chat-name">加载中...</span></h2>
                <div class="user-info">
                ...
                <div class="messages-panel full-width">
                    <div class="panel-header">
                        ...
                        <div class="chat-controls">
                            <button id="return-to-room-btn" class="return-button" style="display: none;">返回社团列表</button>
                        </div>
                    </div>
