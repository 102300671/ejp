    ...
    <div class="container">
            ...
            <div class="chat-content">
                ...
                <div class="chats-panel">
                    <div class="panel-header">
                        <h3>聊天</h3>
                        <button id="create-chat-btn">创建社团</button>
                    </div>
                ...
                <div class="messages-panel">
                    <div class="panel-header">
                        ...
                        <div class="chat-controls">
                                <button id="join-room-btn">加入社团</button>
                                <button id="leave-room-btn">退出社团</button>
                ...
                <div class="activities-panel">
                    <div class="panel-header">
                        <h3>活动和公告</h3>
                        <button id="refresh-activities-btn">刷新</button>
                    </div>
                    <div class="panel-tabs">
                        <button id="tab-activities" class="tab-btn active">📅 活动</button>
                        <button id="tab-announcements" class="tab-btn">📢 公告</button>
                    </div>
                    <div id="activities-list" class="activities-list">
                        <div class="loading">加载中...</div>
                    </div>
                    <div id="announcements-list" class="activities-list" style="display: none;">
                        <div class="loading">加载中...</div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <form id="join-chat-form">
                    <div class="form-group">
                        ...
                        <input type="text" id="join-chat-name" required placeholder="输入要加入的社团名称">
                    </div>
                    <div class="form-group">
        ...
        <div id="room-search-modal" class="modal">
            <div class="modal-content room-search-modal-content">
                ...
                <h3>搜索社团</h3>
                <div class="search-input-container">
                    <input type="text" id="room-search-input" placeholder="输入社团名称进行搜索...">
                    <button id="search-rooms-btn">搜索</button>
                </div>
                <div class="modal-tabs">
                    <button class="tab-btn active" data-tab="search">搜索结果</button>
                    <button class="tab-btn" data-tab="requests">入社申请</button>
                </div>
